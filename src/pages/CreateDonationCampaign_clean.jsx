...
const CreateDonationCampaign = ({ showEndpointInfo = false }) => {
    ...
    const handleSubmit = async (values, { setSubmitting, setFieldError }) => {
        try {
            ...
            // Show loading
            Swal.fire({
                title: 'Creating Donation Campaign...',
                text: 'Please wait while we upload the image and save the campaign information',
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-center">
                        ...
                        <p class="text-lg mb-2"><strong>${values.petName}</strong> donation campaign has been created!</p>
                ...
                if (result.isConfirmed) {
                    ...
                    // Reset form for adding another campaign
        ...
        <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-base text-base-content/70 max-w-2xl mx-auto">
                    Help raise funds for your pet's medical care, food, or other needs by creating a donation campaign
                </p>
            </div>
                                ...
                                <div>
                                    ...
                                    <div className="label">
                                        <span className="label-text-alt text-base-content/60">
                                            The last date when donations will be accepted
                                        </span>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className={`${
                                        ...
                                        <TiptapEditor
                                            ...
                                            placeholder="Provide detailed information about why you need donations and how they will be used"
                                        />
                                    </div>
                                    <div className="label">
                                        <span className="label-text-alt text-base-content/60">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-base-content/70 space-y-1">
                            ...
                            <li>• Your campaign will be visible to all users once created</li>
                            <li>• Be honest and transparent about your pet's needs</li>
