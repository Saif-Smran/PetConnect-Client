...
const AddPet = ({ showEndpointInfo = false }) => {
  ...
  const handleSubmit = async (values, { setSubmitting, setFieldError }) => {
    try {
      ...
      // Prepare pet data - only send what the server expects
      const petData = {
  ...
  return (
    <DashboardLayout activeMenuId="add-pet">
                ...
                <Form className="space-y-8">
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      as="textarea"
                      rows="3"
                      placeholder="A brief, engaging description of your pet (e.g., 'Friendly golden retriever who loves playing fetch')"
                  ...
                  <div>
                    ...
                    <div className={`${
                      ...
                      <TiptapEditor
                        ...
                        placeholder="Provide detailed information about your pet including personality, habits, medical history, training, special needs, ideal home environment, etc."
                      />
                    </div>
                    <div className="label">
                      <span className="label-text-alt text-base-content/60">
